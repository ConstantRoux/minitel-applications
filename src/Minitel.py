...
class Minitel:
    ...
    def write_semigraphical(self, sg_code, foreground, background):
        self.color_semigraphical(self.GRAY_BACKGROUND_HEXACODE[7 - background], self.GRAY_FOREGROUND_HEXACODE[7 - foreground])
        if sg_code != b'\x20':
    ...
    def set_baudrate(self, baudrate):
        list = [300, 1200, 4800, 9600]
        if not baudrate in list:
